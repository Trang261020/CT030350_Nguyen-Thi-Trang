                ...
                function mbTabs(){
                    ...
                    $('> .cdz-nav-tabs > .cdz-tab-link',$tabInner).each(function(id,el){
                        ...
                        $toggle.appendTo($linkWrap).on('click',function(){
                            ...
                            $tabPane.slideToggle(400,function(){
        ...
        _attachEffect: function(type) {
                ...
                $('.level-top', self.element).each(function() {
                    ...
                    $leveltop.hover(function() {
                        ...
                        if (self._currentMode == 'desktop') {
                            if (type == 'slide') {
                                $drop.stop().slideUp(400, function() {
                                    $leveltop.removeClass('open').trigger('animated_out');
                                });
                            } else if (type == 'fade') {
                                $drop.stop().fadeOut(400, function() {
                                    $leveltop.removeClass('open').trigger('animated_out');
                                });
                            } else if (type == 'normal') {
                                $drop.hide();
                ...
                $li.children(conf.subMenu).each(function() {
                    ...
                    if ($li.children(conf.trigger).first().length == 0) {
                        $('<span class="' + conf.triggerClass + '">').insertBefore($subMenu).on('click.showsubmenu', function(e) {
                            e.stopPropagation();
                            e.preventDefault();
                            $subMenu.toggleClass('open').hasClass('open') ? ($li.addClass('open'), $subMenu.slideDown(400)) : ($li.removeClass('open'), $subMenu.slideUp(400));
                        });
                    }
                });
            });
