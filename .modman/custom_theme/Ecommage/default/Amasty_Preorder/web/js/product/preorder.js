define([
    ...
    $.widget('mage.amastyPreorder', {
        ...
        _saveOriginal: function () {
            ...
            if (this.options.addToCartButton.length) {
                ...
                if (originalButtonElement.length > 0) {
                    ...
                    this._original.addToCartLabelText = $.mage.__('Add to Cart');
                }
            }
        },
        ...
        _changeLabels: function() {
            ...
            let addToCartButton = this.options.addToCartButton.parent();
            if (this.options.addToCartButton.is('button')) {
                addToCartButton = this.options.addToCartButton;
            }

            addToCartButton.attr('title', this.options.addToCartLabel);
        },
        ...
        disable: function() {
            ...
            addToCartButton.attr('title', this._original.addToCartLabelText);
        }
    });
