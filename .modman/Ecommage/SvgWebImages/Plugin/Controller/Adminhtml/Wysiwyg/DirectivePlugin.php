...
namespace Ecommage\SvgWebImages\Plugin\Controller\Adminhtml\Wysiwyg;
...
use Magento\Framework\Url\DecoderInterface;use Ecommage\SvgWebImages\Helper\ImageHelper;
...
class DirectivePlugin
{
    ...
    public function aroundExecute(Directive $subject, callable $proceed)
    {
        try {
            ...
            $resultRaw->setContents(file_get_contents($imagePath));// @codingStandardsIgnoreLine
