        ...
        _showDialog: function (imageData) {
            ...
            dialogElement
                ...
                .on('open', $.proxy(function (event) {
                    let onlyMobile = $(event.target).find('[data-role="only-mobile-trigger"]'),
                        isChecked = jQuery('input[type="hidden"][name="'+ onlyMobile.attr('name') + '"]').val();
                    onlyMobile.prop('checked',parseInt(isChecked));
                    $(event.target)
            ...
            dialogElement.on('change', '[data-role="only-mobile-trigger"]', function (e) {
                let isChecked = 0,
                ...
                jQuery('input[type="hidden"][name="'+ attrName + '"]').val(isChecked);
            });
